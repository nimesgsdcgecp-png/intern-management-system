...
import { BulkImportForm } from "@/app/components/forms/BulkImportForm";
            ...
            {/* Compact Header */}
             <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 text-slate-900">
                <div>
                   ...
                   <p className="text-gray-500 mt-2 font-medium italic opacity-80">Import multiple intern profiles via CSV format.</p>
                </div>

                <Link href="/dashboard/admin">
                   <button className="bg-white hover:bg-gray-50 border border-gray-100 rounded-2xl py-4 px-10 text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-3 transition-all active:scale-95 shadow-sm italic text-slate-600">
                ...
                <div className="lg:col-span-12 xl:col-span-4 space-y-10">
                    <div className="rounded-[2.5rem] border border-gray-100 p-10 bg-white shadow-sm overflow-hidden relative group hover:shadow-xl transition-all duration-500">
                       ...
                       <div className="relative z-10 space-y-8">
                          <div className="flex items-center gap-4">
                             ...
                             <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] mb-3 italic">Import Guidelines</h3>
                          </div>
                          <p className="text-sm font-bold text-slate-600 mb-6 italic">Follow these rules to ensure your data is correctly processed.</p>

                         <div className="space-y-6">
                            <div className="space-y-3">
                               <p className="text-[9px] font-black text-indigo-600 uppercase tracking-widest italic flex items-center gap-2">
                               ...
                               <div className="grid grid-cols-1 gap-3">
                                  {["NAME", "EMAIL", "ROLE"].map(item => (
                                     <div key={item} className="flex items-center gap-3 p-3.5 bg-gray-50 rounded-2xl border border-gray-50 hover:bg-white transition-all cursor-default">
                                        ...
                                        <span className="text-[10px] font-black text-slate-900 tracking-[0.2em] italic">{item}</span>
                                     </div>
                                  ))}
                               </div>
                            </div>
                               ...
                               <div className="grid grid-cols-1 gap-3">
                                  {["DEPARTMENT", "PHONE", "MENTOR_EMAIL"].map(item => (
                                     <div key={item} className="flex items-center gap-3 p-3.5 bg-gray-50/50 rounded-2xl border border-transparent opacity-60">
                                        ...
                                        <span className="text-[10px] font-black text-gray-400 tracking-[0.2em] italic">{item}</span>
                                     </div>
                                  ))}
                               </div>
                            </div>
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-12 text-white relative overflow-hidden shadow-xl group cursor-default border-none">
                       ...
                       <div className="relative z-10 font-black">
                          ...
                          <h4 className="text-3xl font-black tracking-tight mb-6 italic uppercase leading-tight underline decoration-indigo-500 decoration-4 underline-offset-8">Security <br />Verification</h4>
                          <p className="text-[10px] font-medium opacity-60 leading-relaxed italic mb-10">
                             All imported records undergo automated validation sequence. Email addresses must be unique within the system domain.
                          </p>
                          <div className="flex items-center gap-4 text-[9px] font-black uppercase tracking-[0.2em] bg-white/5 px-6 py-3 rounded-2xl inline-flex text-indigo-300 border border-white/10 shadow-inner italic">
