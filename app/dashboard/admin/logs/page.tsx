      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-8 text-slate-900">
          <div>
            ...
            <p className="text-gray-500 mt-2 font-medium italic opacity-80">Track all actions and events across the platform.</p>
          </div>
          <div className="relative group max-w-md w-full">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-4 bg-white border border-gray-100 rounded-2xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all font-bold text-slate-700 italic placeholder:text-gray-300 shadow-sm"
            />
          </div>
        </div>
                    ...
                    {loading ? (
                      ...
                      filteredLogs.map((log) => (
                        ...
                        >
                          <td className="px-8 py-5">
                            ...
                            <div className="text-[10px] font-bold text-gray-400 uppercase tracking-tight italic">
                          ...
                          <td className="px-8 py-5">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-sm font-bold text-slate-700 tracking-tight italic">
                                {log.user?.profile?.name || "System"}
                              </span>
                            </div>
                          </td>
                          <td className="px-8 py-5">
                            <span className={`inline-flex px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest italic font-black shadow-sm ${
                          ...
                          <td className="px-8 py-5">
                            <div className="text-xs font-bold text-gray-500 uppercase tracking-widest opacity-70 italic">
                              {log.entity_type}
                            </div>
                            <div className="text-[10px] font-medium text-gray-300 font-mono italic">
                      ...
                      <tr>
                        <td colSpan={4} className="px-8 py-32 text-center">
                          ...
                          <p className="text-gray-400 font-black uppercase tracking-widest text-xs italic">No activity logs recorded</p>
                        </td>
                      </tr>
                    )}
                  </tbody>
              ...
              {selectedLog ? (
                ...
                >
                  <div className="bg-white rounded-[2.5rem] border border-gray-100 overflow-hidden shadow-sm group hover:shadow-xl transition-all duration-500">
                    <div className="p-8 border-b border-gray-50 flex items-center justify-between">
                      ...
                      <button onClick={() => setSelectedLog(null)} className="text-[9px] font-black text-rose-500 hover:text-rose-600 uppercase tracking-widest italic group-hover:scale-105 transition-all">Dismiss</button>
                    </div>
                    <div className="p-8 space-y-8">
                      <div>
                        <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] block mb-4 italic ml-1">Event Data</label>
                        <div className="bg-slate-900 rounded-2xl p-6 overflow-hidden shadow-xl border border-slate-800 group/code">
                          ...
                          <pre className="text-indigo-300 text-[11px] font-mono whitespace-pre-wrap leading-relaxed italic overflow-x-auto max-h-[300px] custom-scrollbar">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        <div className="p-6 bg-gray-50 rounded-4xl border border-gray-100 shadow-sm group/stat hover:bg-white transition-all duration-300">
                          <div className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 italic">Type</div>
                          <div className="text-sm font-black text-slate-900 uppercase tracking-tight italic">{selectedLog.entity_type}</div>
                        </div>
                        <div className="p-6 bg-gray-50 rounded-4xl border border-gray-100 shadow-sm group/stat hover:bg-white transition-all duration-300">
                          <div className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2 italic">Action Level</div>
                          <div className={`text-sm font-black uppercase tracking-tight italic ${selectedLog.action.includes('delete') ? 'text-rose-500' : 'text-indigo-500'}`}>
                ...
                <div className="h-full min-h-[400px] flex items-center justify-center p-12 bg-gray-50/50 rounded-4xl border-2 border-dashed border-gray-100">
                  <div className="text-center group">
                    ...
                    <p className="text-gray-400 font-black text-[10px] uppercase tracking-[0.4em] max-w-[240px] italic leading-relaxed">Select a log entry to view details</p>
                  </div>
                </div>
              )}
            </AnimatePresence>
